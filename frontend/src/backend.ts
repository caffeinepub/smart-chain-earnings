...
import type { Time as _Time, Transaction as _Transaction, TransactionType as _TransactionType, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addBalanceToReferral(arg0: string, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addBalanceToReferral(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createReferralId(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.createReferralId();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllBalances(): Promise<Array<[string, bigint]>> {
        if (this.processError) {
            try {
    ...
    async getBalance(arg0: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getTransactionsByReferral(arg0: string): Promise<Array<Transaction>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTransactionsByReferral(arg0);
                return from_candid_vec_n10(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setBalance(arg0: string, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async transfer(arg0: string, arg1: string, arg2: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async withdraw(arg0: string, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
